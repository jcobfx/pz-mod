...
public class ComponentBackedEnergyContainer extends ComponentBackedContainer<Integer, AttachedEnergy> implements IEnergyContainer {
    ...
    public ComponentBackedEnergyContainer(ItemStack attachedTo,
                                          int containerIndex,
