...
public class AttachmentBackedFluidContainer extends AttachmentBackedContainer<FluidStack, AttachedFluids> implements IFluidContainer {
    ...
    public AttachmentBackedFluidContainer(BlockEntity attachedTo,
                                          int containerIndex,
                                          Supplier<AttachedFluids> newAttachmentCreator,
