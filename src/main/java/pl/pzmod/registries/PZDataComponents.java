...
public class PZDataComponents {
    ...
    public static final Supplier<DataComponentType<Integer>> ENERGY_CONTAINER =
            DATA_COMPONENTS.registerComponentType("energy_container", builder -> builder
                    .persistent(Codec.INT)
                    .networkSynchronized(ByteBufCodecs.INT)
                    .cacheEncoding());
    public static final Supplier<DataComponentType<SimpleFluidContent>> FLUID_CONTAINER =
