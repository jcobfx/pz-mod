...
import pl.pzmod.items.curios.NightVisionGogglesItem;
...
public class PZItems {
    ...
    public static final ItemRegistryObject<BatteryItem> BATTERY = ITEMS.builder("battery", BatteryItem::new)
            .with(Capabilities.EnergyStorage.ITEM, stack ->
    ...
    public static final ItemRegistryObject<BackpackItem> BACKPACK = ITEMS.builder("backpack", BackpackItem::new)
            .with(Capabilities.ItemHandler.ITEM, stack ->
    ...
    public static final ItemRegistryObject<BuckChucketsItem> BUCK_CHUCKETS = ITEMS.builder("buck_chuckets", BuckChucketsItem::new)
            .with(Capabilities.FluidHandler.ITEM, stack ->
                    new FluidHandlerItemStack(PZDataComponents.FLUID_CONTAINER, stack, BuckChucketsItem.CAPACITY))
            .build();
    ...
    public static final ItemRegistryObject<NightVisionGogglesItem> NIGHT_VISION_GOGGLES =
            ITEMS.builder("night_vision_goggles", NightVisionGogglesItem::new)
                    .with(Capabilities.EnergyStorage.ITEM, stack -> new ComponentEnergyStorage(stack,
                            PZDataComponents.ENERGY_CONTAINER.get(), NightVisionGogglesItem.CAPACITY))
                    .build();
